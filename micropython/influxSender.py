...
def send_sensor_data(dht_temp, dht_hum, feels_like, rain_chance, sun_score, sitting, avg_score, total_reviews):
    ...
    payload = f"""bench_data dht_temp={dht_temp},dht_hum={dht_hum},feels_like={feels_like},rain={rain_value},sun_score={sun_score},sitting={int(sitting)},avg_score={avg_score},total_reviews={total_reviews}"""
